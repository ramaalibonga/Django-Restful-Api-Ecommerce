    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location_order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='soko.order')),
            ],
        ),
        migrations.CreateModel(
            name='Product',
            fields=[
                ...
                ('product_photo', models.ImageField(max_length=250, upload_to='uploads/%Y')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='soko.product'),
        ),
        migrations.CreateModel(
            name='Reply',
            fields=[
                ...
                ('reply_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='replies_made', to=settings.AUTH_USER_MODEL)),
                ('reply_to', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='replies_received', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
